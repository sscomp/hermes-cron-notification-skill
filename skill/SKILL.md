...
```bash
HERMES_HOME="$HERMES_HOME" "$HERMES_HOME/bin/hcron" add "每日 03:00 提醒鼎鼎該睡覺了"
HERMES_HOME="$HERMES_HOME" "$HERMES_HOME/bin/hcron" add "每日 09:00 提醒我出門前帶錢包"
HERMES_HOME="$HERMES_HOME" "$HERMES_HOME/bin/hcron" add "2026-04-30T14:00:00+08:00 提醒我和客戶開會"
```
